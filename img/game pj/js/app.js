...
$(document).ready(function() {
    $(".watermelon").click(function() {
        $(".watermelon").addClass("thing");
        $(".watermelon").hide("pulsate", 2500);
        // $(".me").wrap("<del></del>");
        $(".wms").css({
    ...
    $(".cherry").click(function() {
        $(".cherry").addClass("thing");
        $(".cherry").hide("pulsate", 2500);
        // $(".me").wrap("<del></del>");
        $(".chs").css({
            "text-decoration": "line-through",
            opacity: "0.5",
    ...
    $(".banana").click(function() {
        $(".banana").addClass("thing");
        $(".banana").hide("pulsate", 2500);
        // $(".me").wrap("<del></del>");
        $(".bns").css({
            "text-decoration": "line-through",
            opacity: "0.5",
    ...
    $(".orange").click(function() {
        $(".orange").addClass("thing");
        $(".orange").hide("pulsate", 2500);
        // $(".me").wrap("<del></del>");
        $(".ogs").css({
            "text-decoration": "line-through",
            opacity: "0.5",
    ...
    $(".flower").click(function() {
        $(".flower").addClass("thing");
        $(".flower").hide("pulsate", 2500);
        // $(".me").wrap("<del></del>");
        $(".fws").css({
            "text-decoration": "line-through",
            opacity: "0.5",
    ...
    $(".bamboo").click(function() {
        $(".bamboo").addClass("thing");
        $(".bamboo").hide("pulsate", 2500);
        // $(".me").wrap("<del></del>");
        $(".bbs").css({
            "text-decoration": "line-through",
            opacity: "0.5",
    ...
    $(".caterpillar").click(function() {
        $(".caterpillar").addClass("thing");
        $(".caterpillar").hide("pulsate", 2500);
        // $(".me").wrap("<del></del>");
        $(".cps").css({
            "text-decoration": "line-through",
            opacity: "0.5",
    ...
    $(".grape").click(function() {
        $(".grape").addClass("thing");
        $(".grape").hide("pulsate", 2500);
        // $(".me").wrap("<del></del>");
        $(".gps").css({
            "text-decoration": "line-through",
            opacity: "0.5",
    ...
    $(".hints").click(function() {
        if (chance <= 3 && chance >= 0) {
            chance--;
            document.getElementById("ec").textContent = chance;
